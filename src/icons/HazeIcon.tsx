...
export function HazeIcon({ size = 'medium', color = '#000000' }: IconProps) {
  ...
  return (
    <Svg width={px} height={px} viewBox="0 0 48 48" fill="none">
      ...
      <Path d="M32 26C32 23.8783 31.1571 21.8434 29.6569 20.3431C28.1566 18.8429 26.1217 18 24 18C21.8783 18 19.8434 18.8429 18.3431 20.3431C16.8429 21.8434 16 23.8783 16 26" stroke={color} strokeWidth={strokeWidth} {...COMMON} />
