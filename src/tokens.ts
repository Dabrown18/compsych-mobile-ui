export const sys = {
  ...
  typeScale: {
    displayLarge: {
      ...
      sysLineHeight: 80,
      sysTracking: -2.4,
      sysLetterSpacing: -2.4,
      sysFontWeight: 'regular',
      sysFontWeightEmphasized: 'medium',
      sysFontFamily: 'GoogleSans_400Regular',
    },
    displayMedium: {
      sysFontSize: 72,
      sysLineHeight: 79.2,
      sysTracking: -1.44,
      sysLetterSpacing: -1.44,
      sysFontWeight: 'regular',
      sysFontWeightEmphasized: 'medium',
      sysFontFamily: 'GoogleSans_400Regular',
    },
    ...
    labelMedium: {
      ...
      sysLineHeight: 20,
      sysTracking: 0.07,
      sysLetterSpacing: 0.07,
      sysFontWeight: 'medium',
      sysFontWeightEmphasized: 'semibold',
      sysFontFamily: 'GoogleSans_500Medium',
    },
    labelSmall: {
      sysFontSize: 12,
      sysLineHeight: 18,
      sysTracking: 0.12,
      sysLetterSpacing: 0.12,
      sysFontWeight: 'medium',
      sysFontWeightEmphasized: 'semibold',
      sysFontFamily: 'GoogleSans_500Medium',
    },
